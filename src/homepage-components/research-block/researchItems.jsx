...
export const Items=[
    {
        id:'01',
        image:require('../research-block/1.PNG'),
    ...
    {
        id:'02',
        image:require('../research-block/2.PNG'),
        title:'Scheduling on Heterogeneous Multi-core Processors Using Stable Matching Algorithm',
        para:'HMP is becoming mainstream because it has potential to reduce the power consumption and improve the performance than homogeneous core processors',
        skill:'computer science dep.',
    ...
    {
        id:'03',
        image:require('../research-block/3.PNG'),
        title:'Transient Multipath routing protocol for low power and lossy networks',
        para:'RPL routing protocol for low-power and lossy networks is an Internet Engineering Task Force',
    ...
    {
        id:'04',
        image:require('../research-block/4.PNG'),
        title:'Semantic Integration of Heterogeneous Databases of Same Domain Using Ontology',
        para:'Heterogeneous database integration is the study of integrating data from multiple databases',
